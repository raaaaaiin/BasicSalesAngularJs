...
export class productcomponents implements OnChanges{
  @Input() changeview: boolean;
  @Input() searchQuery: string;
  @Output() clickProduct = new EventEmitter<boolean>();
  @Output() signalProductEmit = new EventEmitter<boolean>();
  ...
  ngOnInit() {
   this.productService.getAllProducts().subscribe({
    ...
    this.signalProductEmit.emit(this.clickProductAction);
  }
